...
@Component({
  ...
  templateUrl: './bind-complete-validator.component.html',
  styleUrls: ['./bind-complete-validator.component.css']
})
export class BindCompleteValidatorComponent implements OnInit {
