import {EmployeeInfo} from '../Model/allOfAsyncEmployeeInfo';
...
@Component({
  selector: 'app-all-of-async-add-decorator',
  templateUrl: './all-of-async-add-decorator.component.html',
  styleUrls: ['./all-of-async-add-decorator.component.css']
})
export class AllOfAsyncAddDecoratorComponent implements OnInit {
