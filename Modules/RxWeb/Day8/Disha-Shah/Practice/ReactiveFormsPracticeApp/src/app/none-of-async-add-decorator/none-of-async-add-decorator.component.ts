...
import {EmployeeInfo} from '../Model/noneOfAsyncEmployeeInfo';
@Component({
  selector: 'app-none-of-async-add-decorator',
  templateUrl: './none-of-async-add-decorator.component.html',
  styleUrls: ['./none-of-async-add-decorator.component.css']
})
export class NoneOfAsyncAddDecoratorComponent implements OnInit {
