import { allOfAsync, prop } from "@rxweb/reactive-form-validators"
import { of } from "rxjs"
...
export class EmployeeInfo {
  ...
  @allOfAsync({validatorConfig:of({ matchValues: ["English", "Spanish", "French"], messageKey: 'allOfAsyncMessageKey' })})
  languages: string;
}
