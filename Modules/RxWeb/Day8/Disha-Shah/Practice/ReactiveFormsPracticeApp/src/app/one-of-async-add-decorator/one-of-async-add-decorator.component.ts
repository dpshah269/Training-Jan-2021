...
import {EmployeeInfo} from '../Model/oneOfAsyncEmployeeInfo';

@Component({
  selector: 'app-one-of-async-add-decorator',
  templateUrl: './one-of-async-add-decorator.component.html',
  styleUrls: ['./one-of-async-add-decorator.component.css']
})
export class OneOfAsyncAddDecoratorComponent implements OnInit {
